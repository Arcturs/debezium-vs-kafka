    ...
    fun producerFactory(): ProducerFactory<String, EventMessage> =
        DefaultKafkaProducerFactory(
            mapOf<String, Any>(
                ...
                KEY_SERIALIZER_CLASS_CONFIG to KEY_SERIALIZER_CLASS_NAME,
                VALUE_SERIALIZER_CLASS_CONFIG to VALUE_SERIALIZER_CLASS_NAME
            )
        )

    private companion object {
        const val BATCH_SIZE = 64 * 1024
        const val KEY_SERIALIZER_CLASS_NAME = "org.apache.kafka.common.serialization.StringSerializer"
        const val VALUE_SERIALIZER_CLASS_NAME = "org.springframework.kafka.support.serializer.JsonSerializer"
    }
